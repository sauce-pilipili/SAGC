 ...
 */
final class Version20220331092607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE joueurs DROP age, DROP description, DROP image_debout');
    }
